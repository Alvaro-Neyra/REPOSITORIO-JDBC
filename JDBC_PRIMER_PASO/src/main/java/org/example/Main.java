...
public class Main {
    ...
    public static void buscarClientes(Connection conexion) throws SQLException {
        Statement stmt = null;
        ResultSet rs = null;
    ...
    public static void buscarClientePorCodigo(int codigo, Connection conexion) throws SQLException {
    ...
    public static void buscarClientesPorEmpleado(String empleado, Connection conexion) throws SQLException {
    ...
    public static void getProductosParaReponer(int puntoReposicion, Connection conexion) throws SQLException {
        String sqlQuery = "SELECT DISTINCT prod.id_producto, prod.codigo_producto, prod.nombre, SUM(prod.cantidad_en_stock) FROM producto `prod` WHERE prod.cantidad_en_stock < ? GROUP BY prod.nombre, prod.id_producto, prod.codigo_producto";
        try (PreparedStatement pstmt = conexion.prepareStatement(sqlQuery)) {
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    String nombre = rs.getString("prod.id_producto");
                    count++;
                    System.out.println(count + " - " + idProducto + " - " + codigoProducto + " - " + nombre);
                }
            } catch (SQLException e) {
    ...
    public static void getProductosGama(String nombreGama, Connection conexion) throws SQLException {
    ...
    public static void getPedidosPorCliente(int idCliente, Connection conexion) throws SQLException {
    ...
    public static void getPedidosPorEstado(String pedido, Connection conexion) throws SQLException {
        String sqlQuery = "SELECT * FROM pedido WHERE estado = 'ENTREGADO'";
        try (PreparedStatement pstmt = conexion.prepareStatement(sqlQuery)) {
    ...
    public static void getProductosPorGamaList(Connection conexion) throws SQLException, ClassNotFoundException {
        ...
        try (Statement stmt = conexion.createStatement()) {
            try(ResultSet rs = stmt.executeQuery(sqlQuery)) {
                ...
                while (rs.next()) {
                    count++;
                    System.out.println("Cantidad " + rs.getInt("cantidad") + "- Gama " + rs.getString("gama"));
                }
            }
        } catch(SQLException e) {
            throw new SQLException("Error al obtener los productos: " + e.getMessage());
    ...
    public static void getProductosNoComprados(Connection conexion) throws SQLException, ClassNotFoundException {
    ...
    public static void getPedidosPorProducto(int idProducto, Connection conexion) throws SQLException, ClassNotFoundException {
    ...
    public static void getPedidosPorFechas(String desdeFecha, String hastaFecha, Connection conexion) throws SQLException, ClassNotFoundException {
    ...
    public static void getProductosPorProveedor(int codigoProveedor, Connection conexion) throws SQLException, ClassNotFoundException {
    ...
    public static void getPedidosPorClienteCompleto(int idCliente, Connection conexion) throws SQLException {
    ...
    // Metodo adicional
    public static void getProductosGama(int idGama, Connection conexion) throws SQLException {
        String sqlQuery = "SELECT DISTINCT prod.codigo_producto, prod.nombre, prod.dimensiones, prod.proveedor, prod.descripcion, SUM(prod.cantidad_en_stock), prod.precio_venta, prod.precio_proveedor, gam.id_gama FROM producto `prod` " +
        ...
        try (PreparedStatement pstmt = conexion.prepareStatement(sqlQuery)) {
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                ...
                while (rs.next()) {
                    ...
                    String nombreProducto = rs.getString("nombre");
                    int dimensiones = rs.getInt("dimensiones");
                    ...
                    String gama = rs.getString("gam");
                    count++;
                    System.out.println("Fila: " + count + "-" + codigoProducto + "-" + nombreProducto + "-" + dimensiones + "-" + proveedor + '-' + descripcion + '-' + cantidadEnStock + "-" + precioVenta + "-" + precioProveedor+ "-" + gama);
                }
            }
            catch (SQLException e) {
                throw new SQLException("Error al obtener los productos: " + e.getMessage());
